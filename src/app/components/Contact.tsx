...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      style={{ backgroundColor: '#0D1117', padding: '96px 24px' }}
    >
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        {/* Contact cards */}
        <div
          style={{ display: 'grid', gap: 20, marginBottom: 56 }}
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              gap: 8,
              padding: '14px 32px',
              backgroundColor: sent ? '#0a5f63' : '#0D7377',
              color: '#fff',
              border: 'none',
              borderRadius: 8,
              fontFamily: "'Inter', sans-serif",
            ...
            onMouseEnter={(e) =>
              !sent && (e.currentTarget.style.backgroundColor = '#0a5f63')
            }
            onMouseLeave={(e) =>
              !sent && (e.currentTarget.style.backgroundColor = '#0D7377')
            }
          >
            <Send size={16} />
